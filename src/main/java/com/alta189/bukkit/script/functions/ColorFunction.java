...
public class ColorFunction extends BaseFunction {
	private final Map<String, ChatColor> colors = new HashMap<String, ChatColor>();
	...
	public Scriptable construct(Context cx, Scriptable scope, Object[] args) {
		throw new IllegalArgumentException("Cannot invoke color() as a constructor");
	}
	...
	public Object call(Context cx, Scriptable scope, Scriptable thisObj, Object[] args) {
		...
		String colorName = args[0].toString();
		ChatColor color = colors.get(colorName.toUpperCase());

		if (color != null) {
			return Context.javaToJS(color.toString(), scope);
		}
